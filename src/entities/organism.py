...
AUDITORY_RANGE_ENERGY_COST = 0.015		# 청각 반경당 에너지 비용
...
def compute_biological_traits(genes):
    size                    = genes['size']# 신체 크기 (kg) 0.01 ~ 100000.0
    ...
    auditory_range          = genes['auditory_range']# 청각 감지 반경 (m) 0.0 ~ 10000.0
